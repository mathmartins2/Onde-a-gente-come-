        ...
        >
          {photos.map((photo, photoIndex) => (
            ...
            >
              ...
              <span className="scheme-dark pointer-events-none absolute inset-x-0 bottom-0 truncate bg-[linear-gradient(0deg,color-mix(in_srgb,var(--canvas)_85%,transparent),transparent)] px-1.5 pb-1 pt-3 text-[0.6875rem] text-ink">
                {photo.addedByName}
              </span>
